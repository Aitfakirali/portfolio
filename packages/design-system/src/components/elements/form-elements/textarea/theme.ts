export const textarea = {
  default: {
    base: 'text-base block relative w-full px-3 py-3 border border-gray-300 focus:ring-0 hover:border-primary-300 focus:border-primary-500 shadow rounded placeholder-gray-500 text-primary-800',
    label: 'mb-1',
