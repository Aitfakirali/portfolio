...
export const SelfThought = () => {
  return (
    <Container>
      <div className='relative'>
        <div className='flex flex-col md:flex-row items-center gap-10 pb-20'>
          ...
          <div className='basis-1/2'>
            <Text
              className='md:max-w-lg font-primary text-transparent bg-gradient-to-r to-[#FEBD81] from-[#BFF4A6] bg-clip-text'
      ...
      <div className='flex flex-col md:items-center md:flex-row gap-10 justify-between'>
        ...
        <div className='relative flex-1 flex flex-col items-center justify-center px-2'>
          <PointerArrow />
          <div className='bg-white p-4 -rotate-12 scale-[.9] sm:scale-100 space-y-4 py-10 '>
            <Image
              src='/ramdan_1.webp'
              alt=''
              width={400}
