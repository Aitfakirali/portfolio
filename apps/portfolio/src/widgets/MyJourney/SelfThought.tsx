  ...
  return (
    <Container>
      <div className='relative'>
        <WaveArrow />
        <div className='md:absolute pb-10 md:top-1/2 md:-translate-y-1/2 right-10'>
          <Text
      ...
      <div className='flex flex-col md:items-center md:flex-row gap-10 justify-between'>
        ...
        <div className='relative flex-1 flex flex-col items-center justify-center py-10 overflow-hidden px-2'>
          <PointerArrow />
