...
export const Hero = () => {
  return (
    ...
    //   </div>
    // </div>
    <div className='bg-black min-h-screen grid place-content-center gap-20'>
      <Image
        src='/Avatar.png'
        alt=''
        width={250}
      ...
      <Text
        ...
        className='text-[60px] leading-[80px] text-center bg-gradient-to-r text-transparent bg-clip-text from-[#DBA6F4] to-[#A981FE]'
      >
        <span>
          Hi. I'am Soufiane. <br />
        </span>
